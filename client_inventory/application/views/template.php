					...
					<ul id="sidebarnav">
						...
						<li>
							...
							<div class="user-profile d-flex no-block dropdown m-t-20">
								<div class="user-pic"><img src="<?= base_url('assets/xtreme_admin_lite/'); ?>assets/images/users/danu.png" alt="users" class="rounded-circle" width="40" /></div>
								<div class="user-content hide-menu m-l-10">
									<a href="javascript:void(0)" class="" id="Userdd" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
										<h5 class="m-b-0 user-name font-medium">Danuas Anang Satria<i class="fa fa-angle-down"></i></h5>
										<span class="op-5 user-email">20.01.4460</span>
									</a>
									<div class="dropdown-menu dropdown-menu-right" aria-labelledby="Userdd">
										...
										<div class="dropdown-divider"></div>
										<a class="dropdown-item" href="<?= base_url('') ?>"><i class="fa fa-power-off m-r-5 m-l-5"></i> Logout</a>
									</div>
								</div>
							</div>
							<!-- End User Profile-->
						</li>
						<li class="p-15 m-t-10"><a href="javascript:void(0)" class="btn btn-block create-btn text-white no-block d-flex align-items-center"><i class="fa fa-plus-square"></i> <span class="hide-menu m-l-5">Dashboard</span> </a></li>
						<!-- User Profile-->
						...
						<li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="#" onclick="loadMenu('<?= base_url('laporan_tahunan'); ?>')" aria-expanded="false"><i class="mdi mdi-alert-outline"></i><span class="hide-menu">Laporan Tahunan</span></a></li>
						<li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="#" onclick="loadMenu('<?= base_url('laporan_stock'); ?>')" aria-expanded="false"><i class="mdi mdi-alert-outline"></i><span class="hide-menu">Laporan Stock</span></a></li>
